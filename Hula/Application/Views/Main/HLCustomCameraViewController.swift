...
class HLCustomCameraViewController: BaseViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        guard let chosenImage = HLCustomCameraViewController.imageFromPickerInfo(info) else {
    ...
    func openImagePicker(){
        ...
        // Images only — availableMediaTypes / default library types include video and picking one
