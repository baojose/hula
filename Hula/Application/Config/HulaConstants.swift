...
struct HulaConstants {
    ...
    // Public snapshot: keep OAuth credentials out of source control.
    // Restore the LinkedIn client id/secret from a secure local override for release builds.
    static let linkedinClientId: String = ""
    static let linkedinClientSecret: String = ""
    static let linkedinState: String = "linkedin_oauth_state"
