...
4. **LinkedIn** — rotate the app secret and OAuth state if they were ever committed. Populate `LIAppId`, `LIAppSecret`, `LIState`, `LIRedirectURL`, and the `li<app-id>` URL scheme from private configuration only.
