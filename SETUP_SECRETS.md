...
4. **LinkedIn** — rotate the OAuth client secret and state value. Configure `LIAppId`, `LIClientSecret`, `LIState`, and `LIRedirectURL` from a private build configuration before enabling LinkedIn validation.
