...
4. **LinkedIn** — rotate the client secret/state if they were ever committed. Inject `LIAppId`, `LIClientSecret`, `LIState`, `LIRedirectURL`, and the matching `li<app id>` URL scheme from your private configuration before enabling LinkedIn validation.
