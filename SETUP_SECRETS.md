...
4. **LinkedIn** — rotate the app client secret/state if either was ever committed; replace `LIAppId`, `LinkedInClientSecret`, `LinkedInState`, and the `li...` URL scheme from private configuration before enabling LinkedIn validation.
