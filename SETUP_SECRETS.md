...
4. **LinkedIn** — rotate the OAuth client secret, update `LIAppId`, `LIClientSecret`, `LIState`, `LIRedirectUrl`, and the `li...` URL scheme in `Info.plist` from a private source.
