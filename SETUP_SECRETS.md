...
4. **LinkedIn** — rotate the OAuth client secret and inject the client ID, secret, state, and redirect URL from private configuration before enabling LinkedIn verification.
