...
4. **LinkedIn** — rotate the OAuth client secret if it was ever committed, then replace the `LIAppId`, `LIClientSecret`, `LIState`, `LIRedirectURL`, and `li...` URL scheme placeholders from your secure configuration.
