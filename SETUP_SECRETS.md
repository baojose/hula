...
2. **LinkedIn** — rotate the OAuth client secret, generate a new CSRF `state`, and inject `LIAppId`, `LIClientSecret`, `LIOAuthState`, `LIRedirectURL`, and the matching `li<app id>` URL scheme from a private build configuration.
