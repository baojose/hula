...
4. **LinkedIn** — rotate the OAuth client secret and inject `LIAppId`, `LIClientSecret`, `LIRedirectUrl`, and `LIState` through a private `Info.plist` or build-setting overlay.
