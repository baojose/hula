...
4. **LinkedIn** — rotate the client secret and update `LIAppId`, `LIClientSecret`, `LIState`, `LIRedirectUrl`, and the `li...` URL scheme from private configuration before enabling LinkedIn validation.
