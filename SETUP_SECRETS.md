...
2. **LinkedIn** — rotate the app client secret and state value, then inject `LIAppId`, `LIAppSecret`, and `LIState` into `Hula/Info.plist` from your private configuration.
